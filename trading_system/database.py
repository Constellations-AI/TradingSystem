...
class Database:
    ...
    def init_database(self):
        ...
        with self.get_connection() as conn:
            ...
            cursor.execute("CREATE INDEX IF NOT EXISTS idx_api_calls_hash ON raw_api_calls (provider, function_name, parameters_hash)")
            cursor.execute("CREATE INDEX IF NOT EXISTS idx_api_calls_created ON raw_api_calls (created_at)")
            cursor.execute("CREATE INDEX IF NOT EXISTS idx_briefings_session ON market_briefings (session_id)")
